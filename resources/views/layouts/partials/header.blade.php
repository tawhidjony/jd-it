<div class="bg-white shadow top-nav dark:bg-slate-900">
    <div class="toggle-nav">
        <span id="toggleIcon" class="text-2xl cursor-pointer las la-bars"></span>
    </div>
    ...
    <div class="flex items-center gap-6">
        ...
        <div class="relative">
            ...
            <div id="dropdown_content"
                class="absolute right-0 z-50 hidden w-48 py-1 mt-2 bg-white rounded-md shadow-lg">
                <div class="px-4 py-2 text-xs text-gray-400">Manage Account</div>
                <a href="#" class="block px-4 py-2 text-sm leading-5 text-gray-700 transition hover:bg-gray-100"><i
                        class="las la-user-circle"></i> Profile</a>
                <div class="border-t border-gray-100"></div>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a class="block px-4 py-2 text-sm leading-5 text-gray-700 transition hover:bg-gray-100"
